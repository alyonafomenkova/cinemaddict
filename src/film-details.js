...
class FilmDetails {
    ...
    <form class="film-details__inner" action="" method="get">
      ...
      <div class="film-details__info-wrap">
        <div class="film-details__poster">
          <img class="film-details__poster-img" src="images/posters/${this._posters}" alt="${this._posters}">
  ...
  bind() {
    //console.log('BIND det');
    this._element.querySelector(`.film-details__close`).addEventListener(`click`, this._onCloseBtnClick);
  }

  unbind() {
    //console.log('UNBIND det');
    this._element.querySelector(`.film-details__close`).removeEventListener(`click`, this._onCloseBtnClick);
  }
